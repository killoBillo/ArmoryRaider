...
require_once('GuildArmory.class.php');
require_once('CharacterArmory.class.php');
...
class BattlenetArmory {
	 ...
	 */
   	...
   	public function getCharacter($name,$realm = ''){
   		...
   		$character = new CharacterArmory($this->region, $realm , $name, $this->characterExcludeFields);
   		return $character;
   	}
   	...
   	public function getGuild($name,$realm = ''){
   		...
   		$guild = new GuildArmory($this->region, $realm , $name);
   		return $guild;
   	}
